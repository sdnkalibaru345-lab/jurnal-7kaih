(function () {
  ...
  const isStudyActivity = text => hasContext(text, /(belajar|membaca|baca(?: buku)?|menulis|berhitung|mengerjakan|ngerjain|menyelesaikan|tugas(?: kelompok)?|\bpr\b|pekerjaan rumah|latihan(?: soal)?|soal|menghafal|hafalan|mengulang pelajaran|diskusi|presentasi|praktik|praktek|les|kursus|materi|pelajaran|matematika|\bmtk\b|bahasa indonesia|bahasa inggris|bahasa sunda|ipas|ipa|ips|pancasila|agama|seni|pjok|koding|coding|komputer|sains)/i);
  const isSocialActivity = text => hasContext(text, /(membantu|bantu(?: ibu| ayah| orang tua| ortu| tetangga)?|menolong|pekerjaan rumah|mencuci|cuci(?: baju| pakaian| piring)?|nyuci|menyapu|nyapu|mengepel|ngepel|memasak|merapikan|beres.?beres|bersih.?bersih|membersihkan|membereskan|membuang sampah|buang sampah|lipat baju|melipat pakaian|menjemur|menyiram tanaman|merawat tanaman|kerja bakti|gotong royong|piket|bakti sosial|donasi|berbagi|menjaga adik|mengasuh adik|kegiatan masyarakat|kegiatan lingkungan|rapat warga|ronda|posyandu|karang taruna|lomba|mushola|masjid)/i);
